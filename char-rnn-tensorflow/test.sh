...
python train.py --num_epochs 200 --save_dir 'lstm_2x_400' --rnn_size 512 --num_layers 4 --model 'lstm' --savehistory lstm_2x_400_trainingHistory.txt
...
# (rnn 2x)
python train.py --num_epochs 200 --save_dir 'rnn_2x_400' --rnn_size 512 --num_layers 4 --model 'rnn' --savehistory rnn_2x_400_trainingHistory.txt
...
# (gru 2x)
python train.py --num_epochs 200 --save_dir 'gru_2x_400' --rnn_size 512 --num_layers 4 --model 'gru' --savehistory gru_2x_400_trainingHistory.txt
