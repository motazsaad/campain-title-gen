...
# (rnn 2x)
python train.py --num_epochs 150 --save_dir 'rnn_2x_400' --rnn_size 512 --num_layers 4 --model 'rnn' --seq_length 50 --learning_rate 1 --savehistory rnn_2x_400_trainingHistory.txt
...
# (gru 2x)
python train.py --num_epochs 150 --save_dir 'gru_2x_400' --rnn_size 512 --num_layers 4 --model 'gru' --seq_length 50 --learning_rate 1 --savehistory gru_2x_400_trainingHistory.txt
