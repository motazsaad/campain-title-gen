...
##
## (rnn 2x)
#python train.py --num_epochs 150 --save_dir 'rnn_2x_400' --rnn_size 512 --num_layers 4 --model 'rnn' --savehistory rnn_2x_400_trainingHistory.txt
#
## run 1
...
##
## (gru 2x)
#python train.py --num_epochs 150 --save_dir 'gru_2x_400' --rnn_size 512 --num_layers 4 --model 'gru' --savehistory gru_2x_400_trainingHistory.txt
#
## run 1
...
# run 1
python sample.py --n 12 --prime "international" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "hotel" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "deals" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "coupon" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "reservation" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "rates" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "great" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "cost" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "expedia" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "save" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "no" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "book" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "big" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "vietnam" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "canton mA" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "best prices" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "accommodation" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "carnegie mellon university" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --prime "guarantee" --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
...
# run 3 'without prime'
python sample.py --n 12 --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
python sample.py --n 12 --perplexity_file 'description/NER/input.txt' --outcsv 'NER_tf_word_level.csv' --save_dir 'NER_lstm_0x_2000'
